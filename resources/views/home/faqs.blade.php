        ...
        <div class="row gx-md-8 gx-xl-12 gy-10">
            <div class="col-lg-6">
                <div class="d-flex flex-row">
                    <div>
                        <span class="icon btn btn-sm btn-circle btn-primary disabled me-5">
                    ...
                    <div>
                        ...
                        <p class="mb-3">
                            Todos nuestros sorteos se realizan en coordinación con los sorteos de la <a target="_blank" href="http://www.lotenal.gob.mx/">Lotería Nacional</a> para la Asistencia Pública mexicana.
                        </p>
