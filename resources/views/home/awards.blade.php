<section class="wrapper bg-light wrapper-border">
    <div class="container py-10 py-md-12">
        ...
        <div class="row gx-md-8 gx-xl-12 gy-10 justify-content-center">
            <div class="col-lg-11">
                <div class="carousel owl-carousel" data-margin="30" data-nav="true" data-dots="true" data-autoplay="false" data-autoplay-timeout="5000" data-responsive='{"0":{"items": "1"}, "768":{"items": "2"}, "992":{"items": "2"}, "1200":{"items": "3"}}'>            
                    <div class="item">
